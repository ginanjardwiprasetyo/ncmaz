...
export default function useGetPostsNcmazMetaByIds(props: Props) {
	// loading-DOM hanya dibaca cabang like user login -> tetap gate login di effect ke-2
	...
	// ponytail: gate dihapus — tamu (anonim) juga perlu count segar, API publik
	useEffect(() => {
		if (isFetchAPI || !IDsString) {
			return
		}
		setIsFetchAPI(true)
